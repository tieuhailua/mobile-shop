...
<div class="head-bg">
    <div class="container-fluid">
        <div class="d-flex align-items-center">
            {{-- Logo --}}
            <div class="w-7">
                <a href="{{route('user/index')}}" class='head-brand' style="color: chocolate">
                    Home
                </a>
            </div>
            ...
            <div class="w-93">
                <div class="head-items">
                    <div class="d-flex align-items-center justify-content-lg-between">
                        {{-- điện thoại --}}
                        <a href="{{route('user/dien-thoai')}}" class='head-item pt-15 pb-15 white' style="color: rgb(228, 137, 18)">SHOPMOBILE</a>
                        <a href="{{route('user/about')}}" class='head-item pt-15 pb-15 white' style="color: rgb(252, 166, 8)">About US</a>
                        <a href="{{route('user/contact')}}" class='head-item pt-15 pb-15 white' style="color: rgb(253, 141, 13) ">Contact US</a>
                                        ...
                                        <div class='white head-account'>
                                            ...
                                            <div class='head-account-dropdown'>
                                                ...
                                                <a href="{{route('user/tai-khoan-don-hang')}}" class='head-account-option'>
                                                    <span><i class="fas fa-box mr-10"></i>My order</span>
                                                    @if ($data['processing'] != 0)
                                                        <span class='processing-qty number-badge ml-10'>{{$data['processing']}}</span>
                                                    @endif
                                                </a>
                                                {{-- đăng xuất --}}
                                                <a href="{{route('user/logout')}}" class='head-account-option'><i class="far fa-power-off mr-10"></i>Log out</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @else
                            {{-- đăng nhập/đăng ký --}}
                            <div class="head-item">
                                <a href="{{route('user/dang-nhap')}}" class='head-item white'><i class="fas fa-user mr-10" style="color: chocolate"></i>login</a>
                                <span class="ml-10 mr-10 fz-26 white">|</span>
                                <a href="{{route('user/dang-ky')}}" class='head-btn-signup'>Registration</a>
                            </div>
                        @endif
                    </div>
                </div>     
            ...
            <div class='d-flex flex-column justify-content-center p-20'>
                    ...
                    <div class="relative">
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="offcanvas-account-option">
                                <a href="{{route('user/tai-khoan')}}" class="offcanvas-account-single-option"><i class="fas fa-user mr-10"></i>View Accounts</a>
                ...
                @else
                    <div class='d-flex justify-content-center align-items-center'>
                        ...
                        <a href="{{route('user/dang-nhap')}}" class='black fw-600'>Login</a>
                        <b class='ml-10 mr-10'>|</b>
                        <a href="{{route('user/dang-ky')}}" class='main-btn'>Registration</a>
                    </div>
                @endif
                <hr>
                ...
                <div class='head-drop-2 head-offcanvas-item text-center pb-20'>
                    <a href="{{route('user/dien-thoai')}}" class="fw-600">SHOPMOBILE</a>
                </div>

                {{-- giỏ hàng --}}
                <div class='head-offcanvas-item pb-20'>
                    <div class='d-flex align-items-center justify-content-center'>
                        <a href="{{route('user/gio-hang')}}" class="fw-600">almighty</a>
                    </div>
                </div><hr>
                ...
                <div class='d-flex justify-content-start'>
                    <div class='d-flex flex-column pt-20'>
                        ...
                        <div class='d-flex flex-column mt-10 ml-30'>
                            <span><i class="fas fa-phone mr-5"></i>090 293 2589</span>
                            <span><i class="fas fa-phone mr-5"></i>093 210 3748</span>
                        </div>
                    </div>
                </div>
            </div>
