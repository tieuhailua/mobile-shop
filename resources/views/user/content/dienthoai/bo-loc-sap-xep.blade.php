                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div type="button" name="filter-item" data-type="price" data-keyword="20-30" class="filter-item"> 20 - 30 triệu</div>
                            <div type="button" name="filter-item" data-type="price" data-keyword="30" class="filter-item">Trên 30 triệu</div>
                        </div>
                    </div>
                    <div class="col-md-6">
