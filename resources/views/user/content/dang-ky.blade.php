<!DOCTYPE html>
<html lang="en">
    @section("title")Registration | HaiLuaMobile @stop
                    ...
                    <div class="login-signup-box">
                        ...
                        <form id="signup-form" action="{{route('user/signup')}}" method="POST">
                            ...
                            <div id='enter-information'>
                                {{-- title --}}
                                <div class="mb-30">
                                    <h2 class="fw-600">Registration</h2>
                                </div>
                                ...
                                {{-- nút tiếp tục --}}
                                <div class="mb-10">
                                    <div type='button' id='signup-step-1' class='main-btn w-100'>Continue</div>
                                </div>
                                <div class="d-flex justify-content-center mb-30">Already have an account? <a href="{{route('user/dang-nhap')}}" class="ml-5">Login</a></div>
                                ...
                                {{-- về trang chủ --}}
                                <a href={{route('user/index')}} class="d-flex align-items-center"><i class="far fa-chevron-left mr-10 fz-14"></i>On the homepage</a>
                            </div>
                            ...
                            <div id="enter-verify-code" class="none-dp">
                                ...
                                <div class="mb-30">
                                    <h3 class="fw-600">Enter Auth Code</h3>
                                    <div>Verification code has been sent to your phone number <b id="tel-confirm"></b></div>
                                </div>
                                ...
                                <div type="button" id="signup-step-2" class="main-btn">continue</div>
                            </div>
    
                            {{-- enter password --}}
                            <div id='enter-password' class="none-dp">
                                <div class="mb-30">
                                    <h3 class="fw-600">Account information</h3>
                                </div>
    
                                {{-- họ tên --}}
                                <div class="mb-3">
                                    <label for="su_fullname" class="fw-600 form-label">First and last name</label>
                                    <input type="text" id='su_fullname' name="su_fullname" placeholder="Họ và tên" required>    
                                </div>
    
                                {{-- mật khẩu --}}
                                <div class="mb-3">
                                    <label for="su_pw" class="fw-600 form-label">password?</label>
                                    <input type='password' id="su_pw" name="su_pw">
                                </div>
    
                                {{-- nhập lại mật khẩu --}}
                                <div class="mb-3">
                                    <label for="su_re_pw" class="fw-600 form-label">Enter the password</label>
                                    <input type='password' id="su_re_pw" name="su_re_pw">
                                </div>
    
                                <div type='button' id='signup-step-3' class="main-btn">Registration</div>
                            </div>
                        </form>
                    </div>
                </div>
