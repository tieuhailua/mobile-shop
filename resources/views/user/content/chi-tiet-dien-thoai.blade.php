...
@section("breadcrumb")
    <a href="{{route('user/dien-thoai')}}" class="bc-item">ShopMobile</a>
        ...
        <div class='row'>
            ...
            @else
                <div class='col-lg-4 col-md-6 mb-20 fz-14'>
                    ...
                    <div>
                        Liên hệ
                        <b class="ml-5 mr-5">0902932589</b>hoặc
                        <b class="ml-5 mr-5">0932103748</b> Để được tư vấn
                    </div>
                    <hr>
                    @include('user.content.components.chitiet.right-side')
                </div>
                                                ...
                                                <div class='d-flex'>
                                                    ...
                                                    <div class='d-flex flex-column justify-content-between pl-20'>
                                                        <div class="d-flex align-items-center flex-wrap">
                                                            ...
                                                            <div class="success-color fz-14"><i class="fas fa-check-circle mr-5"></i>Đã mua hàng tại HaiLuaMobile</div>
                                                        </div>
