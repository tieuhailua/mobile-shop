...
@section("breadcrumb")
    ...
    @switch($page)
        {{-- thông báo --}}
        @case('sec-thong-bao')
            @section("title")Thông báo |HaiLuaMobile @stop
            <a href="{{route('user/tai-khoan-thong-bao')}}" class="bc-item active">Thông báo</a>
            @break
        {{-- đơn hàng --}}
        @case('sec-don-hang')
            @section("title")Đơn hàng |HaiLuaMobile @stop
