<!DOCTYPE html>
<html lang="en">
    @section("title") Login | HaiLuaMobile @stop
            ...
            <div class='row'>
                <div class='col-lg-5 col-md-8 col-12 mx-auto'>
                    <div class="login-signup-box">
                        ...
                        @endif
                        <h3 class='mb-30 fw-600'>Login</h3>
                        ...
                        <form id="login-form" action="{{route('user/login')}}" method="POST">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-20">
                                <div>
                                    ...
                                    <label for="remember" class='form-check-label'>remember login</label>
                                </div>
                                <a href="{{route('user/khoi-phuc-tai-khoan')}}">Forgot password?</a>
                            </div>
        
                            <!-- button đăng nhặp -->
                            <div id="btn-login" class='main-btn w-100 mb-10'>Login</div>
                            <div class="d-flex justify-content-center mb-30">no account? <a href={{route('user/dang-ky')}} class="ml-5">Registration</a></div>
