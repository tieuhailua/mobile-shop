...
<div class="navigation">
    ...
    <a href={{route('admin/dashboard')}} class="d-flex align-items-center">
        <div class="fz-22 ml-10 white">ADMIN HaiLuaMobile </div>
    </a>
    ...
    <div class="relative d-flex justify-content-end align-items-center pl-100 pr-20">
        ...
        <div class="account-option">
            <a href="{{route('admin/dashboard')}}" class="single-option"><i class="fas fa-home mr-10"></i>Dashboard</a>
            <a href="{{route('taikhoan.index')}}" class="single-option"><i class="fas fa-user-alt mr-10"></i>view account</a>
            <a href="{{route('user/logout')}}" class="single-option"><i class="far fa-power-off mr-10"></i>Log out</a>
        </div>
    </div>
</div>